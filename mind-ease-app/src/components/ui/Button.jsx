...
const Button = ({ children, variant = "default", size = "default", className ="", ...props }) => {
	const variants = {
		default: "inline-flex items-center justify-center px-5 py-3 rounded-md shadow-md transition active:scale-95 bg-[#1D3557] text-white hover:bg-blue-700",
		primary: "inline-flex items-center justify-center px-5 py-3 rounded-md bg-[#1D3557] text-white hover:bg-blue-700",
		secondary: "inline-flex items-center justify-center px-5 py-3 rounded-md shadow-md transition active:scale-95 bg-[#1D3557] text-white hover:bg-blue-700"
	}
